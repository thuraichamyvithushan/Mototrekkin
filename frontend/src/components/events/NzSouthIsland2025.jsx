      ...
      <div className=" flex flex-col md:flex-row items-center gap-6">
        <div className="py-8 px-4 bg-white w-full md:w-1/2 rounded-lg">
          <div className="space-y-2 text-gray-600">
            ...
            <p><strong>PRICING:</strong> Multiple options: Request info kit for details</p>
...
Luggage support, 
Verified routes, 
and Request info kit for full details</p>
            <p><strong>PARTNERS:</strong> Partners are accepted. See info kit for full details</p>
          </div>
        </div>
...
<div className="flex flex-col lg:flex-row max-w-6xl mx-auto gap-8 pt-20">
  <div className="lg:w-1/2 text-left">
        ...
        <p className="text-gray-600 mb-4">
          But here’s the catch – only 30 spots are available. That’s the maximum number of adventure bikes we can accommodate, and once they’re gone, they’re gone.
        </p>
        <p className="text-gray-600 mb-4">
        ...
        <p className="text-gray-600 mb-6">
          Get the full details – pricing, inclusions, dates – in our Event Information Kit. Fill out the form below now to receive your download link.
        </p>
      </div>
...
export default NzSouthIsland2025;