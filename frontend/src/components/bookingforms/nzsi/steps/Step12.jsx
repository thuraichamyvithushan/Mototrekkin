...
const Step12 = ({ formData, handleInputChange, errors, calculateTotalPayment }) => {
  ...
  const totalToPay = formData.paymentOption === 'Deposit'
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        {formData.selectedMotorcycle && formData.hireOption === 'Hire a Motorcycle' && (
          <div className="bg-gray-100 p-4 rounded-lg mb-4">
            <h5 className="text-lg font-semibold text-gray-900 mb-2">Bike Hire</h5>
            <div className="mb-4">
              <div className="flex items-center space-x-4">
                {bikeImages[formData.selectedMotorcycle] ? (
                  <img
                    src={bikeImages[formData.selectedMotorcycle]}
